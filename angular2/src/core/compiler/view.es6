...
export class ProtoView {
  ...
  bindDirectiveProperty(directiveIndex, expression, setterName, setter, isContentWatch) {
    assert.argumentTypes(directiveIndex, assert.type.number, expression, AST, setterName, assert.type.string, setter, SetterFn, isContentWatch, assert.type.boolean);
...
//# sourceMappingURL=/Users/cburgdorf/Documents/hacking/angular/modules/angular2/src/core/compiler/view.map
