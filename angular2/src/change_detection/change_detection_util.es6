...
function _isBlank(val) {
  return assert.returnType((isBlank(val) || val === uninitialized), assert.type.boolean);
}
...
//# sourceMappingURL=/Users/cburgdorf/Documents/hacking/angular/modules/angular2/src/change_detection/change_detection_util.map
